...
-- Clean naming convention: No FK_ prefixes, concise foreign key names
...
COMMENT ON TABLE "Bookings" IS 'Service booking records linking customers, vehicles, services, and technicians';
COMMENT ON TABLE "Payments" IS 'Payment transactions for bookings';
COMMENT ON TABLE "AdCampaigns" IS 'Advertisement campaigns created by advertisers';
